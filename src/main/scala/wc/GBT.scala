...
object GBT {
  ...
  def main(args: Array[String]) {
    ...
    val ss = SparkSession.builder().appName("GBT").master("local[1]").getOrCreate()
...
val stages = Array(labelIndexer, assembler, gbt)
...
var feature_imp = model.stages(2).asInstanceOf[GBTClassificationModel].featureImportances.toDense
